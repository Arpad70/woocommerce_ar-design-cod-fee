...
final class ArDesignCodFeeRollbackManager
{
    private const BACKUP_DIR = 'ard-cod-fee-backups';
    ...
    public function rollbackOnInstallFailure($result, $hookExtra)
    {
        ...
        return new \WP_Error(
            'ard_cod_fee_rollback_performed',
            __('Aktualizácia AR Design COD Fee zlyhala. Predchádzajúca verzia bola automaticky obnovená zo zálohy.', 'ar-design-cod-fee')
        );
    }
