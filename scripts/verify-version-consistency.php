...
$pluginFile = $pluginRoot . '/ar-design-cod-fee.php';
...
if (! preg_match("/define\\(\\s*'AR_DESIGN_COD_FEE_VERSION'\\s*,\\s*'" . preg_quote($version, '/') . "'\\s*\\)/", $pluginSource)) {
    $errors[] = 'AR_DESIGN_COD_FEE_VERSION does not match VERSION file.';
}
