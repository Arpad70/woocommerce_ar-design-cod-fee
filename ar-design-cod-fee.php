...
define('AR_DESIGN_COD_FEE_VERSION', '1.0.4');
...
add_action('plugins_loaded', function () {
    ...
    require_once AR_DESIGN_COD_FEE_PLUGIN_PATH . 'includes/Settings.php';
    require_once AR_DESIGN_COD_FEE_PLUGIN_PATH . 'includes/CodFee.php';
    require_once AR_DESIGN_COD_FEE_PLUGIN_PATH . 'includes/Gateway.php';
